...
class DashboardRequestHandler(SimpleHTTPRequestHandler):
    ...
    def __init__(self, *args, **kwargs):
        self.static_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'dashboard_dist')
    ...
    def do_POST(self):
        ...
        if path == '/api/config':
            ...
            t = threading.Thread(target=_run_query_async, args=(query_id, preset, dataset_file, body_data.get('params')), daemon=True)
            t.start()
