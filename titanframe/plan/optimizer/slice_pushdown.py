        ...
        if isinstance(plan, Limit):
            ...
            if isinstance(child, Scan):
                ...
                if scan_limit is not None:
                    ...
                    new_scan = Scan(source=child.source, format=child.format, schema=child._schema, projection=child.projection, predicate=child.predicate, limit=new_limit, chunk_size=child.chunk_size)
