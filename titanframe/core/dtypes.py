...
class DType:
    ...
    def is_numeric(self) -> bool:
        return self.category in (DTypeCategory.SIGNED_INTEGER, DTypeCategory.UNSIGNED_INTEGER, DTypeCategory.FLOATING)

    @property
    def is_integer(self) -> bool:
        return self.category in (DTypeCategory.SIGNED_INTEGER, DTypeCategory.UNSIGNED_INTEGER)
...
ALL_DTYPES: list[DType] = [Int8, Int16, Int32, Int64, UInt8, UInt16, UInt32, UInt64, Float32, Float64, Bool, Utf8, Binary, Date, Datetime, Duration, Null]
...
def from_python_type(python_type: type) -> DType:
    _PYTHON_TO_DTYPE: dict[type, DType] = {int: Int64, float: Float64, str: Utf8, bool: Bool, type(None): Null}
    ...
    for i, a in enumerate(unsigned):
        for j, b in enumerate(unsigned):
            if i != j:
                ...
                _register_promotion(a, b, result)
    _cross_promote = {(Int8, UInt8): Int16, (Int8, UInt16): Int32, (Int8, UInt32): Int64, (Int8, UInt64): Int64, (Int16, UInt8): Int16, (Int16, UInt16): Int32, (Int16, UInt32): Int64, (Int16, UInt64): Int64, (Int32, UInt8): Int32, (Int32, UInt16): Int32, (Int32, UInt32): Int64, (Int32, UInt64): Int64, (Int64, UInt8): Int64, (Int64, UInt16): Int64, (Int64, UInt32): Int64, (Int64, UInt64): Int64}
...
def promote(left: DType, right: DType) -> DType:
    ...
    raise TypeError(f'Cannot promote types {left} and {right}. Arithmetic between {left.category.value} and {right.category.value} is not supported.')
