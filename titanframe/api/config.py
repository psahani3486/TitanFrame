...
class TitanFrameConfig:
    ...
    nvme_spill_limit: int = field(default_factory=lambda: 100 * 1024 ** 3)  # 100GB default

    # Execution settings
    chunk_size: int = 65536          # 64K rows per chunk
    spill_threshold: float = 0.85    # Spill when memory > 85% full
