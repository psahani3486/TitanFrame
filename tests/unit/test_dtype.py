...
from titanframe.core.dtypes import DType, DTypeCategory, Int8, Int16, Int32, Int64, UInt8, UInt16, UInt32, UInt64, Float32, Float64, Bool, Utf8, Binary, Date, Datetime, Duration, Null, ALL_DTYPES, from_arrow, from_name, from_python_type, from_value, promote, can_cast
...
class TestDTypeProperties:
    ...
    @pytest.mark.parametrize('dtype, expected_category', [(Int8, DTypeCategory.SIGNED_INTEGER), (Int16, DTypeCategory.SIGNED_INTEGER), (Int32, DTypeCategory.SIGNED_INTEGER), (Int64, DTypeCategory.SIGNED_INTEGER), (UInt8, DTypeCategory.UNSIGNED_INTEGER), (UInt16, DTypeCategory.UNSIGNED_INTEGER), (UInt32, DTypeCategory.UNSIGNED_INTEGER), (UInt64, DTypeCategory.UNSIGNED_INTEGER), (Float32, DTypeCategory.FLOATING), (Float64, DTypeCategory.FLOATING), (Bool, DTypeCategory.BOOLEAN), (Utf8, DTypeCategory.STRING), (Binary, DTypeCategory.BINARY), (Date, DTypeCategory.TEMPORAL), (Datetime, DTypeCategory.TEMPORAL), (Duration, DTypeCategory.TEMPORAL), (Null, DTypeCategory.NULL)])
    ...
    @pytest.mark.parametrize('dtype, expected_width', [(Int8, 1), (Int16, 2), (Int32, 4), (Int64, 8), (UInt8, 1), (UInt16, 2), (UInt32, 4), (UInt64, 8), (Float32, 4), (Float64, 8), (Bool, 1), (Utf8, -1), (Binary, -1)])
...
class TestArrowConversion:
    ...
    @pytest.mark.parametrize('dtype, arrow_type', [(Int8, pa.int8()), (Int16, pa.int16()), (Int32, pa.int32()), (Int64, pa.int64()), (UInt8, pa.uint8()), (UInt16, pa.uint16()), (UInt32, pa.uint32()), (UInt64, pa.uint64()), (Float32, pa.float32()), (Float64, pa.float64()), (Bool, pa.bool_()), (Utf8, pa.utf8()), (Binary, pa.binary()), (Null, pa.null())])
