...
def generate():
    ...
    df = pd.DataFrame({'l_orderkey': orderkey, 'l_partkey': partkey, 'l_quantity': quantity, 'l_extendedprice': extendedprice, 'l_discount': discount, 'l_tax': tax, 'l_returnflag': returnflag})
